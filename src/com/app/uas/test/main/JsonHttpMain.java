...
public class JsonHttpMain {
	...
	private static Response getERPLogin(String phone,String password,String master) {
		cleardata();
	...
	private static void getERPNewsList(String sessionId) {
		cleardata();
	...
	private static void getERPNoticesDetail(int id) {
		cleardata();
	...
	private static void getERPNoticesList(String sessionId) {
		cleardata();
		url=Constans.ERP_NEWS;
        final Map<String,Object> param=new HashMap<>();
	...
	private static void getERPNewsDetail(String id,String sessionId) {
		cleardata();
	...
	/**
	  ...
	  * @功能:下载附件
	  */
	private static void getERPDownload(String id,String sessionId) {
		cleardata();
