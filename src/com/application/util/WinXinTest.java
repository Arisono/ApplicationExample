...
import com.application.base.HttpUtil.Response;
...
public class WinXinTest {
	...
	private static String getAccessToken() {
		...
		try {
			...
			Response response = com.application.base.HttpUtil.sendGetRequest(
	...
	private static void pushAMessage(String access_token) {
		try {
			...
			Response response = com.application.base.HttpUtil.sendPostRequest(
 	...
 	public static void WeixinAddGroup(String token){
 		...
 		try {
 			Response  response =com.application.base.HttpUtil.sendPostRequest(url, param,false,false);
