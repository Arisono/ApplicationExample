...
public class AndroidPushMsgToSingleDevice {
	public static void main(String[] args) throws PushClientException,
		...
		try {
			...
			notification.put("title", "杀死进程的推送消息");
			notification.put("description","百度推送正文");
			...
			jsonCustormCont.put("url", "http://www.baidu.com"); //鑷畾涔夊唴瀹癸紝key-value
			notification.put("custom_content", jsonCustormCont);
			
			PushMsgToSingleDeviceRequest request = new PushMsgToSingleDeviceRequest()
					.addChannelId("3955136970545093253")
